        ...
        <div class="row align-items-center gx-5">
            <div class="col-lg-6">
                <div class="hero-content">
                    ...
                    <h1 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">Transfer Money Across The World
                        In Real time</h1>
                    <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">{{$settings->site_name}}
                        transformed the digital banking industry using data and technology more than ten years ago. We
                        are now one of the largest digital banking providers, dedicated to innovating, simplifying, and
                        humanizing banking.</p>
                    ...
                    <div class="hero-contact" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                        ...
                        <div class="hero-contact-text">
                            <p>Need Help? Contact our <a href="contact" class="link style1">digital support</a> &amp;
                                tell us about your query.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="feature-item-wrap">
                        <div class="feature-item">
                            ...
                            <div class="feature-text">
                                ...
                                <p>William believes technology should serve people. His approach focuses on
                                    making everyday financial experiences seamless and empowering.</p>
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                            ...
                            <div class="feature-text">
                                <h3>Driven by Transparency & Vision</h3>
                                <p>With clarity and speed, William has led projects that bring more trust
                                    and accountability to modern digital solutions.</p>
                            </div>
                        </div>
                    </div>
                    <a href="about" class="btn style1">LEARN MORE<i class="ri-arrow-right-s-line"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                <div class="about-content">
                    <div class="content-title style1">
                        ...
                        <p>We've grown to become one of the largest digital banking providers, committed to inventing,
                            simplifying, and humanizing the banking experience.</p>
                    </div>
                    <div class="feature-item-wrap">
                        <div class="feature-item">
                            <div class="feature-icon">
                            ...
                            <div class="feature-text">
                                ...
                                <p>Our mobile app service is quick and easy to use, and you can get it from your app
                                    store.</p>
                            </div>
                        </div>
                        <div class="feature-item">
                            ...
                            <div class="feature-text">
                                ...
                                <p>Our digital banking services are transparent and quick, and we're building a reliable
                                    network.</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="feature-slider-one owl-carousel">
            ...
            <div class="feature-card style3">
                ...
                <p>To enable our clients to convert, we at Stana Group provide the finest currency rates in the market.
                </p>
            ...
            <div class="col-lg-6 order-lg-1 order-md-2 order-2" data-aos="fade-up" data-aos-duration="1000"
                ...
                <div class="wh-content">
                    <div class="content-title style1">
                        ...
                        <p>{{$settings->site_name}} transformed the credit card business using data and technology more
                            than ten years ago. We are now one of the largest digital banking providers, dedicated to
                            innovating, simplifying, and humanizing banking.</p>
                    </div>
                    <div class="feature-item-wrap">
                        <div class="feature-item">
                            <div class="feature-icon">
    ...
    <div class="container">
        ...
        <div class="testimonial-slider-two owl-carousel">
            ...
            <div class="testimonial-card style3" style="min-height: 300px;">
                ...
                <p class="client-quote">I opened a checking and savings account at {{$settings->site_name}} on McHenry
                    in Modesto, California. The teller who helped me was a pleasure to work with. She was very
                    knowledgeable and through setting up my accounts. She made my day a pleasant day. Thank you for the
                    terrific customer service.</p>
            </div>
            ...
            <div class="testimonial-card style3" style="min-height: 300px;">
                ...
                <p class="client-quote">I've been with {{$settings->site_name}} for four years. I went through a loan
                    modification with them, as well as a six-month forbearance. I also have a credit card with them,
                    which they have cancelled after every late payment, as well as a cash account with withdrawal fees.
                    They are always there to help me.</p>
            </div>
            <div class="testimonial-card style3" style="min-height: 300px;">
                <div class="client-info-area">
                    <div class="client-info-wrap">
                ...
                <p class="client-quote">Karla treated me as if I were a person, not simply a customer. She remained on
                    the phone with me until I had calmed down and she was satisfied that I was fine. She stated that she
                    would not be able to go until she had further information. </p>
            </div>
            <div class="testimonial-card style3" style="min-height: 300px;">
                <div class="client-info-area">
                    <div class="client-info-wrap">
                ...
                <p class="client-quote">I usually request service through the app or website, although I have called in
                    on occasion. They're all extremely responsive and accommodating.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                <div class="blog-card style2">
                    ...
                    <div class="blog-info">
                        ...
                        <h3><a href="https://www.cnbc.com/2020/02/27/5-things-every-new-business-owner-needs-to-know-before-starting.html"
                                target="_blank">5 Things You Need To Know Before Starting Business</a></h3>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                <div class="blog-card style2">
                    ...
                    <div class="blog-info">
                        ...
                        <h3><a href="https://www.investopedia.com/articles/insights/122016/9-common-effects-inflation.asp#:~:text=An%20overall%20rise%20in%20prices,fast%20at%20the%20higher%20rate."
                                target="_blank">Effect Of Inflation On Our Daily Expenditure</a></h3>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                <div class="blog-card style2">
                    ...
                    <div class="blog-info">
                        ...
                        <h3><a href="https://www.airtreks.com/go/foreign-currency/" target="_blank">7 Tips To Get Best
                                Exchange Rate In Currency</a></h3>
                    </div>
                </div>
            </div>
        </div>
